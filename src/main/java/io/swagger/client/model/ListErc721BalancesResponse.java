...
import io.swagger.client.model.Erc721TokenBalance;
...
public class ListErc721BalancesResponse {
  ...
  @SerializedName("erc721TokenBalances")
  ...
  **/
  @Schema(required = true, description = "The list of ERC-721 token balances for the address.")
