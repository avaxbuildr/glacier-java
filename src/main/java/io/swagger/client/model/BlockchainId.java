 ...
 */
@JsonAdapter(BlockchainId.Adapter.class)
public enum BlockchainId {
  ...
  public static class Adapter extends TypeAdapter<BlockchainId> {
    @Override
    public void write(final JsonWriter jsonWriter, final BlockchainId enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public BlockchainId read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return BlockchainId.fromValue((String)(value));
    }
  }
}
