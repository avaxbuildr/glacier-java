 ...
 */
@JsonAdapter(PChainId.Adapter.class)
public enum PChainId {
  ...
  public static class Adapter extends TypeAdapter<PChainId> {
    @Override
    public void write(final JsonWriter jsonWriter, final PChainId enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public PChainId read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return PChainId.fromValue((String)(value));
    }
  }
}
