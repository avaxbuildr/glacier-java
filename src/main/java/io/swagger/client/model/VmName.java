 ...
 * Gets or Sets VmName
 */
@JsonAdapter(VmName.Adapter.class)
public enum VmName {
  EVM("EVM"),
  BITCOIN("BITCOIN"),
  ETHEREUM("ETHEREUM");
  ...
  public static class Adapter extends TypeAdapter<VmName> {
    @Override
    public void write(final JsonWriter jsonWriter, final VmName enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public VmName read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return VmName.fromValue((String)(value));
    }
  }
}
