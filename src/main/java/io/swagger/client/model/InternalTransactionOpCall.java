 ...
 */
@JsonAdapter(InternalTransactionOpCall.Adapter.class)
public enum InternalTransactionOpCall {
  ...
  public static class Adapter extends TypeAdapter<InternalTransactionOpCall> {
    @Override
    public void write(final JsonWriter jsonWriter, final InternalTransactionOpCall enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public InternalTransactionOpCall read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return InternalTransactionOpCall.fromValue((String)(value));
    }
  }
}
