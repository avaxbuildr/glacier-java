 ...
 */
@JsonAdapter(XChainId.Adapter.class)
public enum XChainId {
  ...
  public static class Adapter extends TypeAdapter<XChainId> {
    @Override
    public void write(final JsonWriter jsonWriter, final XChainId enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public XChainId read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return XChainId.fromValue((String)(value));
    }
  }
}
