...
public class OperationsApiTest {
     ...
     */
    @Test
    public void getOperationResultTest() throws Exception {
        String operationId = null;
        OperationStatusResponse response = api.getOperationResult(operationId);
     ...
     */
    @Test
    public void postTransactionExportJobTest() throws Exception {
        CreateTransactionExportRequest body = null;
        OperationStatusResponse response = api.postTransactionExportJob(body);
